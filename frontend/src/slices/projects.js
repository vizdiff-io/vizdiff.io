...
export const getProjects = () => async (dispatch, getState) => {
  ...
  try {
    ...
    handleError(err, dispatch, getProjectsFailure, "There was an issue retrieving your Projects")
  }
}
...
export const createProject = (data) => async (dispatch, getState) => {
  ...
  try {
    ...
    handleError(err, dispatch, createProjectFailure, "There was an issue creating your Project")
  }
}
...
export const updateProject = (data) => async (dispatch, getState) => {
  ...
  try {
    ...
    handleError(err, dispatch, updateProjectFailure, "There was an issue updating your Project")
  }
}
...
export const deleteProject = (ids) => async (dispatch, getState) => {
  ...
  try {
    ...
    handleError(err, dispatch, deleteProjectFailure, "There was an issue deleting this Project")
  }
}
...
export const projectsSetSelector = createSelector(projectsSelector, (projectsState) => {
  const projects = projectsState.data || []
  return new Set(projects.map((project) => project.githubRepoUrl))
})

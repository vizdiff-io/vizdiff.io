          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ mb: 0.5 }}>
              ...
              <Tooltip title={data.commitSha}>
                <MuiLink
                  href={getCommitUrl(data.commitSha, data.repoUrl, data.prNumber)}
                  target="_blank"
              ...
              on{" "}
              <MuiLink
                href={getBranchUrl(data.branch, data.repoUrl)}
                target="_blank"
                rel="noopener noreferrer"
                sx={{ fontFamily: "monospace" }}
              >
              ...
              {data.prNumber && (
                <>
                  {" • "}
                  <MuiLink
                    href={getPullRequestUrl(data.prNumber, data.repoUrl)}
                    target="_blank"
                    rel="noopener noreferrer"
                    onClick={(e) => e.stopPropagation()} // Prevent triggering the parent Link
                  >

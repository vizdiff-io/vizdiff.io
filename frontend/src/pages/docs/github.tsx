...
const markdown = `
Getting Started with VizDiff (GitHub) 🚀
===

> Using self-hosted GitLab instead? See the [GitLab setup guide](/docs).
...
export default function GitHubDocumentation(): JSX.Element {
  return (
    <>
      <Seo
